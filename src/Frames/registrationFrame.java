...
public class registrationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rpass2 = new javax.swing.JTextField();
        ...
        rpass2.setBorder(null);
        rpass2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rpass2ActionPerformed(evt);
            }
        });
        jPanel1.add(rpass2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 313, 34));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 144, 21));
        ...
        jPanel1.add(rname, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 60, 313, 34));

        runame.setBorder(null);
        jPanel1.add(runame, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 313, 34));

        rpass.setBorder(null);
        jPanel1.add(rpass, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 313, 34));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\ASUS\\Desktop\\Final Project\\rsz_photo-1505142468610-359e7d316be0.jpg")); // NOI18N
    ...
    private void rpass2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rpass2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rpass2ActionPerformed
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        ...
        if (rpass.getText().equals(rpass2.getText())) {
            String query = "INSERT INTO `user` (`u_name`, `u_username`, `password`) VALUES ('"+rname.getText()+"', '"+runame.getText()+"', '"+rpass.getText()+"');";
    ...
    private javax.swing.JTextField rpass2;
